...
//<img class="d-block img-fluid" src="foto/Album_3/032501.png" id="slide1_Img_0" alt="Nav" onclick="Ok(0)" style="height: 760px;">

//   <div class="col-12 col-lg-6">

// function imgSize(cels){
//   let img = new Image();
//   img.src = cels;
//   //console.log("Platums:", img.width, "Augstums:", img.height); 
